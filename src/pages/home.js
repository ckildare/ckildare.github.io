  ...
  return (
    <div className={styles.homeContainer}>
      <div className={styles.photoContainer}>
        <Image width={100} height={100} src={headShot} alt={"A headshot photo of me."}/>
        <Image width={221} height={218} src={photoWithGageFriends} alt={"Me with my little brother and some friends."}/>
      </div>
